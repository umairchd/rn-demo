...
export const Item = () => {
  ...
  const updateQuanityMethod = (type: string) => {
    switch (type) {
      case '+':
    ...
    <React.Fragment>
      <ScrollView>
        ...
        <Container>
          ...
          {params.salePrice ? (
            <Typography color="red">
              ...
              <Typography
                color="#522973"
                style={params.salePrice ? styles.discounted : undefined}
              >
                SAR {params.price}
              </Typography>
            </Typography>
          ...
          {/* {params.salePrice ? (
            <Typography color={'#522973'} fontSize={18}>
        ...
        <Container>
          ...
          <Typography fontSize={18} style={{marginTop: 10}} weight="semiBold">
            Customization
          </Typography>
          <TextInput
            mode="flat"
      ...
      <Cart quantity={quantity} update={updateQuanityMethod} />
    </React.Fragment>
  );
};
